...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    constructor() {
        ...
        debt_USDT = 2000000000; // 2916378221684 = 2916378.221684 เพราะ USDT เป็น integer 6 decimal
    ...
    function uniswapV2Call(
        ...
        WETH.transfer(address(uniswapV2Pair_WBTC_USDT), repay_WBTC);//change Pool1 from WETH/USDT to WBTC/USDT*********************************************************
        ...
        uint amountOut_WETH = getAmountOut(WBTC.balanceOf(address(this)), reserve_WBTC_Pool2, reserve_WETH_Pool2); //ETH ที่เป็นกำไร 
        uniswapV2Pair_WBTC_WETH.swap(0, amountOut_WETH, address(this), "");
